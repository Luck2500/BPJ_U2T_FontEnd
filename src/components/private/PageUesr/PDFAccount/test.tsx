import {
  ...
  import myCustomFont from "./NotoSerifThai-VariableFont_wdth,wght.ttf";  //ประกาศ import 1 ตัวแปร โดยจากตำแหน่งฟอนต์ที่ดาวโหลดจาก google font ใส่โปรเจ็ค  
  import { Account } from "../../../../app/models/Account";
  
  Font.register({ family: "My_Custom_Font", src: myCustomFont }); //การเรียกใช้ฟอนต์
  //Font.register({ family: "My_Custom_Font", src:"/Cs63/s18/PJEnd/"+ myCustomFont, }); //การเรียกใช้ฟอนต์ตอนอัฟขึ้นเซิฟเวอร์
  interface Prop {
    account: Account[];
  }
  ...
  function PDFAccount({ account }: Prop) {
    ...
    const styles = StyleSheet.create({
      pageStyle: {
        ...
        paddingBottom: 56,
        fontFamily: "MyFont", //ใช้ฟอนต์ได้ตลอดไฟล์
      },
